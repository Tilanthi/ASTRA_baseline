...
python -m astra_core.metacognitive.meta_context_engine
python -m astra_core.self_teaching.autocatalytic_compiler
python -m astra_core.reasoning.cognitive_relativity_navigator
python -m astra_core.intelligence.multi_mind_orchestrator

# Test integrated system
python -m astra_core.v4_revolutionary.integration
