"""
Quantum Applications Domain Module for ASTRA
...
class QuantumApplicationsDomain(ComputationalDomainModule):
    """
    ...
    referral = ("No quantum-computing capability is present.")
    ...
    def initialize(self, global_config: Dict[str, Any]) -> None:
        ...
        logger.info("Initialising %s domain (no computational backend)", "quantum_applications")
...
def create_quantum_applications_domain() -> QuantumApplicationsDomain:
