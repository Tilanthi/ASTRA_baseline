...
"""
Fast Radio Bursts Domain Module for ASTRA
...
class FastRadioBurstsDomain(ComputationalDomainModule):
    """
    Fast Radio Bursts.
    ...
    referral = ("No FRB dispersion-measure or burst modelling is present. For generic time-series periodicity see the signal_processing domain.")
    ...
    def initialize(self, global_config: Dict[str, Any]) -> None:
        ...
        logger.info("Initialising %s domain (no computational backend)", "frbs")
...
def create_frbs_domain() -> FastRadioBurstsDomain:
