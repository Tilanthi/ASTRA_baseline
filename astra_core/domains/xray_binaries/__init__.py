"""
X-ray Binaries Domain Module for ASTRA
...
class XrayBinariesDomain(ComputationalDomainModule):
    """
    X-ray Binaries.
    ...
    referral = ("No X-ray binary spectral or accretion-state modelling is present. For orbital solutions see the orbital_dynamics domain.")
    ...
    def initialize(self, global_config: Dict[str, Any]) -> None:
        ...
        logger.info("Initialising %s domain (no computational backend)", "xray_binaries")
...
def create_xray_binaries_domain() -> XrayBinariesDomain:
