...
"""
Theoretical Astrophysics Domain Module for ASTRA
...
class TheoreticalAstrophysicsDomain(ComputationalDomainModule):
    """
    ...
    referral = ("This is a meta-domain with no routines of its own; specific calculations live in the relevant physical domains.")
    ...
    def initialize(self, global_config: Dict[str, Any]) -> None:
        ...
        logger.info("Initialising %s domain (no computational backend)", "theoretical_astrophysics")
...
def create_theoretical_astrophysics_domain() -> TheoreticalAstrophysicsDomain:
