"""
V104 Adversarial Discovery -- compatibility module.

The V5.0 discovery capabilities were originally published as flat modules at
``astra_core.capabilities.v104_adversarial_discovery``. The subpackage reorganisation moved the
implementation to ``astra_core.capabilities.discovery.adversarial_discovery`` but left nothing behind
...
There is no separate implementation here: these are the same objects.
    ...
    >>> from astra_core.capabilities.v104_adversarial_discovery import AdversarialDiscoverySystem
    >>> from astra_core.capabilities.discovery.adversarial_discovery import AdversarialDiscoverySystem as canonical
    >>> AdversarialDiscoverySystem is canonical
    True

New code should import from ``astra_core.capabilities.discovery.adversarial_discovery``.
"""

from __future__ import annotations

from .discovery.adversarial_discovery import (  # noqa: F401
