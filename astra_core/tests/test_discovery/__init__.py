...
"""
V5.0 Discovery Enhancement System - Test Package

This package contains tests for all V5.0 discovery capabilities:
...
from .test_v5_capabilities import V5TestSuite, V5TestResult, main
