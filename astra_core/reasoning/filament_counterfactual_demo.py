...
# Package imports (the old spec_from_file_location hack is no longer needed
# now that astra_core.reasoning imports resolve normally)
...
from . import integration_bus_stub
